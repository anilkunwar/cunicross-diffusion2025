...
C_NI_BOTTOM = 4.0e-4 #1.3e-4      # Bottom (y=0): Ni-rich
Ly = 50.0             # Domain height (μm)
...
def main():
    ...
    st.title("2D PINN Simulation: Ni Self-Diffusion for Liquid Solder Height = 50 micrometers")
