...
# FIX: Ensure output directory exists for logging and files
OUTPUT_DIR = '/tmp/pinn_solutions'
os.makedirs(OUTPUT_DIR, exist_ok=True)  # Create dir if missing (fixes FileNotFoundError)
...
# FIXED: Cleaner side BC (pure MSE on gradients, requires_grad on y/t, no scaling/clamping)
